                                        ...
                                        <table class="table table-bordered table-hover table-striped" id="datatables">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form method="post" action="{{ route('masyarakat.delete',$p->id) }}"> {{ csrf_field() }}
                                                            <a href="/masyarakat/detail/{{ $p->id }}" class="btn btn-sm btn-inverse-info btn-fw">Detail</a>
                                                            <a href="/masyarakat/edit/{{ $p->id }}" class="btn btn-sm btn-inverse-success btn-fw">Edit</a>
